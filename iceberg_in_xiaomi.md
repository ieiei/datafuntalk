...
![3-2 数据湖 Iceberg 在小米的落地及实践-01](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-01.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-02](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-02.png)

### 第一章： Iceberg技术简介

首先介绍一下Iceberg这个技术。这个大家应该都知道，因此在这一块上我们简短一点

![3-2 数据湖 Iceberg 在小米的落地及实践-03](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-03.png)

Iceberg是一个基于大型分析型数据上的一个表格式，它允许将一些文件、数据集以表的形式提供给spark、trino、prestodb、flink、hive这些计算引擎



![3-2 数据湖 Iceberg 在小米的落地及实践-04](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-04.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-05](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-05.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-06](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-06.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-07](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-07.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-08](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-08.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-09](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-09.png)

### 第二章： Iceberg在小米的一些应用场景

介绍完iceberg一些背景知识，在第二章我们介绍一下iceberg在小米的一些实践以及一些场景。

![3-2 数据湖 Iceberg 在小米的落地及实践-10](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-10.png)

现在iceberg表在我们小米大概有4000多张表，数据大概是8PB，其中v1表大概是1000多张，v2表大概是3000多张。像v1表主要是一些日志场景，v2表是可以配一些需要通过主键进行更新的场景。

![3-2 数据湖 Iceberg 在小米的落地及实践-11](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-11.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-12](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-12.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-13](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-13.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-14](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-14.png)

以下是我们数据入湖的一个简单产品化的页面，有一个schema的对应关系，左边是mysql，右边是我们的iceberg表。在这个示例中，用户是没有选择使用自增主键，而是选择了一个自己的业务id（order_id)来做key。

![3-2 数据湖 Iceberg 在小米的落地及实践-15](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-15.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-16](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-16.png)

这是我们内部的一个日志入湖场景下的产品化。我们在最后一行加了个时间分区的映射，用户可以选择Talos（Kafka）的一个记录时间，也可以选择以一个实际的业务时间来做时间分区。这样用户在数据入湖的选择上就会更多。

![3-2 数据湖 Iceberg 在小米的落地及实践-17](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-17.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-18](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-18.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-19](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-19.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-20](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-20.png)

### 第三章：基于Iceberg的流批一体的探索

介绍完我们的当前场景后，我们更进一步基于iceberg，做了一些流批一体上的探索。

![3-2 数据湖 Iceberg 在小米的落地及实践-21](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-21.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-21](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-22.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-22](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-23.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-23](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-24.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-24](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-25.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-25](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-26.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-27](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-27.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-28](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-28.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-29](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-29.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-30](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-30.png)

### 第四章：未来规划

第四个最后我们介绍一下我们未来的规划。

![3-2 数据湖 Iceberg 在小米的落地及实践-31](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-31.png)
...
![3-2 数据湖 Iceberg 在小米的落地及实践-32](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-32.png)



以上就是我本次的分享，谢谢大家。![3-2 数据湖 Iceberg 在小米的落地及实践-33](./images/xiaomi-iceberg/3-2 数据湖 Iceberg 在小米的落地及实践-33.png)
